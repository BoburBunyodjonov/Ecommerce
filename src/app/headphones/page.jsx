...
const Headphones = () => {
  const [loading, setLoading] = useState(true);
    ...
    const getproducts = async()=>{
        const res = await fetch("http://localhost:4000/earphones");
            ...
            <div className="flex z-20 ">
              ...
              <div className="w-[75%] bg-[#F6F8FA] p-5">
                <Banner/>
                {
                  ...
                  : 
                  <>
                    <h1 className="py-3 flex items-center text-2xl font-semibold space-x-5"> <MdShoppingBag className="text-[#1FBA4A]" />Smartfonlar</h1>
